...
Handler for PHP logging library [Monolog](https://github.com/nholuongut/monolog) for sending log entries to 
...
```bash
$ composer require nholuongut/cwh:^2.0
```
...
## Frameworks integration
 ...
 - [Symfony](http://symfony.com/doc/current/logging.html) ([Example](https://github.com/nholuongut/cwh/issues/10#issuecomment-296173601))
 ...
 [And many others](https://github.com/nholuongut/monolog#framework-integrations)
...
## Issues
Feel free to [report any issues](https://github.com/nholuongut/cwh/issues/new)

## Contributing
Please check [this document](https://github.com/nholuongut/cwh/blob/master/CONTRIBUTING.md)
